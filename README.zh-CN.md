...
![CLILoom 主工作区，展示多个并行终端](docs/images/zh-CN/main-workspace.png)

在同一页面查看多个并行分支的实时终端输出。
...
![CLILoom AI CLI 助手，展示已配置并启动的 Codex](docs/images/zh-CN/assistant.png)

配置并启动 Codex，在独立的交互式终端窗口中使用它。
