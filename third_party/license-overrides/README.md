...
The npm archives for the packages mapped here declare a license but omit the corresponding license file. `scripts/generate-third-party-notices.cjs` fails closed for any other missing text.
